...
// ==========================================================
// === FUNGSI INI DIPERBARUI (downloadNetworkImage) ===
// ==========================================================
/**
...
function downloadNetworkImage() {
    ...
    try {
        ...
        // Menambahkan maxSize untuk memastikan seluruh diagram digambar,
        // bukan hanya bagian yang terlihat di layar.
        const img = diagram.makeImage({
            scale: 1, 
            background: "#121212", 
            maxSize: new go.Size(Infinity, Infinity) // <-- TAMBAHAN INI
        });
        // --- AKHIR PERBAIKAN ---
