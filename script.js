...
// (populateDateFilters() sudah dihapus)

// searchMembers (Tidak Diubah dari versi sebelumnya)
...
// ==========================================================
// === FUNGSI BARU UNTUK MENGHITUNG DOWNLINE ===
// ==========================================================
/**
 * Menghitung jumlah total downline (langsung dan tidak langsung) secara rekursif.
 * @param {Array} allMembersList - Daftar lengkap semua anggota.
 * @param {string} parentUid - UID anggota yang ingin dihitung downline-nya.
 * @returns {number} - Jumlah total downline.
 */
function getDownlineCount(allMembersList, parentUid) {
    const directChildren = allMembersList.filter(m => m.upline === parentUid);
    let count = directChildren.length; // Mulai dengan jumlah anak langsung

    // Untuk setiap anak langsung, hitung juga semua bawahan mereka
    for (const child of directChildren) {
        count += getDownlineCount(allMembersList, child.uid); // Tambahkan jumlah cucu, cicit, dst.
    }
...
// ==========================================================
// === FUNGSI INI DIPERBARUI (displaySearchResults) ===
// ==========================================================
...
// resetSearch (Tidak Diubah dari versi sebelumnya)
...
// --- NETWORK VISUALIZATION (Tidak Diubah dari versi sebelumnya) ---
